...
public class ServerLists {
    ...
    public ServerLists(DesignFrame hoofdframe) {
        ...
        DatabaseServer ServerOptie1 = new DatabaseServer(0,"WD10239",90,99.99);
        DatabaseServer ServerOptie2 = new DatabaseServer(0,"WD10240",95,130.4);
        DatabaseServer ServerOptie3 = new DatabaseServer(0,"WD10241",98,2200);
        WebServer ServerOptie4 = new WebServer(0,"HAL10239",80,99.99);
        WebServer ServerOptie5 = new WebServer(0,"HAL10240",90,130.4);
        WebServer ServerOptie6 = new WebServer(0,"HAL10241",95,2200);
